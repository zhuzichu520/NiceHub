object Dep {
    ...
    const val widget = "com.github.zhuzichu520:widget:${Version.widget}"
    const val libs = "com.github.zhuzichu520:libs:${Version.libs}"
    const val mvvm = "com.github.zhuzichu520:mvvm:${Version.mvvm}"
    ...
    const val kotlinStadlibJdk8 = "org.jetbrains.kotlin:kotlin-stdlib-jdk8:${Version.kotlin}"
    ...
    const val rxbinding = "com.jakewharton.rxbinding3:rxbinding-core:${Version.rxbinding}"
    const val autodispose = "com.uber.autodispose:autodispose:${Version.autodispose}"
    const val autodisposeAndroid = "com.uber.autodispose:autodispose-android:${Version.autodispose}"
